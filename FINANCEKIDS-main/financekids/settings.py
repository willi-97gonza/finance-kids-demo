...
import dj_database_url  # ← Para base de datos en Render
...
# CSRF - Configuración para desarrollo
...
# ------------------------
# MIDDLEWARE (con WhiteNoise siempre activo)
# ------------------------
MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',
    'whitenoise.middleware.WhiteNoiseMiddleware',  # ← WhiteNoise siempre activo para archivos estáticos
...
# ------------------------
# CONFIGURACIÓN PARA PRODUCCIÓN (HTTPS, HSTS, etc.)
# ------------------------
if not DEBUG:
